...
import '../../../ui/widget/dialog_builder.dart';
...
class _HeaderButtonBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future<void> handlePay() async {
      ...
      final encryptedPin = context.appServices.encryptPin(keystore);
      ...
      await context.appServices.updateAsset(asset.assetId);
    ...
    return Padding(
      ...
      child: HeaderButtonBarLayout(buttons: [
        ...
        HeaderButton.text(
          ...
          onTap: () => context
              .push(swapPath, queryParameters: {'output': asset.assetId}),
        ),
        if (mixinAuth != null)
          HeaderButton.text(
            text: '提现',
